...
![alt text](net-lab-3/image/1.1.png)
...
![alt text](net-lab-3/image/2.2.png)
+ 使用md5sum比较两个文件是否完全相同
![alt text](net-lab-3/image/2.3.png)
+ 使用tcp替换其中任意一端，并对比结果是否相同
![alt text](net-lab-3/image/2.4.png)
![alt text](net-lab-3/image/2.5.png)
![alt text](net-lab-3/image/2.6.png)
![alt text](net-lab-3/image/2.7.png)